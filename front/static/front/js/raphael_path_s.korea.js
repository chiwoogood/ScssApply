...
//////////////////////////////////////////////////////////////////////////////
   ...
   // SVG 지도의 각 지역 클릭 이벤트 처리
   var regions = document.querySelectorAll('#south path'); // SVG 지도의 각 지역 요소를 가져옴

   regions.forEach(function(region) {
       region.addEventListener('click', function() {
           var cityName = region.id; // 클릭한 지역의 ID를 가져옴
           var articleId = cityName.toLowerCase(); // 아티클의 ID는 지역 이름과 동일하게 설정함

           // 해당 지역의 아티클을 찾아서 보이도록 설정
